...
<body>
    ...
    <h4 style="text-align: center;">LAPORAN PESERTA MAGANG</h4>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Universitas</th>
                <th>Tanggal Mulai</th>
                <th>Tanggal Selesai (Rencana)</th>
                <th>Status Magang</th>
                <th>Tanggal Selesai Aktual</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($selectedData as $data)
                <tr>
                    ...
                    <td>{{ $data->npm }}</td>
                    <td>{{ $data->univ}}</td>
                    <td>{{ $data->tgl_mulai_magang }}</td>
                    <td>{{ $data->tgl_selesai_magang_rencana }}</td>
                    <td>{{ $data->status_penyelesaian }}</td>
                    <td>{{ $data->tanggal_penyelesaian_aktual ?? 'N/A' }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
