    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('start_time', fn (Absensi $model) => substr($model->start_time, 0, -3) . "-" . substr($model->batas_start_time, 0, -3))
            ->addColumn('end_time', fn (Absensi $model) => substr($model->end_time, 0, -3) . "-" . substr($model->batas_end_time, 0, -3))
            // ->addColumn('batas_start_time')
            // ->addColumn('end_time')
            // ->addColumn('batas_end_time')
            ->addColumn('created_at')
            ->addColumn('created_at_formatted', fn (Absensi $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'));
    }
